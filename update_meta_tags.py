...
HTML_PATH = "index.html"  # путь в репо

# Инициализируем Pytrends
...
if 'name="keywords"' in content:
    content = re.sub(r'<meta name="keywords".*?>',
                     f'<meta name="keywords" content="{keywords_meta}">', content, flags=re.IGNORECASE)
else:
